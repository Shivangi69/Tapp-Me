//
//  WorkerReportDraftDescription.swift
//  Tapp Me
//
...
struct WorkerReportDraftDescription: View {
                                ...
                                VStack{
                                    ...
                                    VStack( alignment: .leading, spacing:10 ){
                                        ...
                                        VStack{
                                            ...
                                            let datestrng = DateConverter.convertDatetotime(dateString: reportidmodeldata.workerReportResponse.createdAt)
...
//                                            }
                                ...
                                VStack(alignment: .leading){
                                    Text("Report Submitted")
                                        ...
                                        .foregroundColor(.black)
                                        .padding(.leading, 5.0)
                                    ReportlistPickerViewWithsavedValue(value: $CompanyName,value1 : reportidmodeldata.workerReportResponse.etaskReportStatus,
                                    ...
                                    tasklistviewVM.eTaskReportStatus = reportidmodeldata.workerReportResponse.etaskReportStatus
                                    CompanyName = reportidmodeldata.workerReportResponse.etaskReportStatus
                                }
...
//                                                            }
                                                            ...
                                                            Button(action: {
                                                                obs.workReportDocID = imageUrlString.workReportDocID
                                                                
                                                                obs.deletedata()
                                                                
                                                                if let index = obs.workerReportDocRes.firstIndex(where: { $0.workReportDocID == imageUrlString.workReportDocID }) {
                                                                      obs.workerReportDocRes.remove(at: index)
                                                                  }
                            ...
                            VStack(alignment: .center, spacing: 15){
                                ...
                                Button(action: {
                                    ...
                                    if selectedImages.count != 0 {
                                        ...
                                        tasklistviewVM.taskid =  reportidmodeldata.workerReportResponse.reportID
                                        tasklistviewVM.UpdateTaskReport{
                                        self.presentationMode.wrappedValue.dismiss()
                                        }
            ...
            .onAppear(){
                ...
                handleLocationAndTaskCreation()
                tasklistviewVM.isDraft = false
                showlocation = reportidmodeldata.workerReportResponse.location
                tasklistviewVM.descriptionText = reportidmodeldata.workerReportResponse.description
                tasklistviewVM.eTaskReportStatus = reportidmodeldata.workerReportResponse.etaskReportStatus
                CompanyName = reportidmodeldata.workerReportResponse.etaskReportStatus
...
struct ReportlistPickerViewWithsavedValue: View {
