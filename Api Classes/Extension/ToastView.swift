...
open class ToastView: UIView {
  ...
  @objc open dynamic var textInsets = UIEdgeInsets(top: 15, left: 10, bottom: 15, right: 10)
  ...
  private let textLabel: UILabel = {
    ...
    self.font = {
      switch UIDevice.current.userInterfaceIdiom {
      // specific values
      case .phone: return .systemFont(ofSize: 18)
      case .pad: return .systemFont(ofSize: 21)
      case .tv: return .systemFont(ofSize: 26)
      case .carPlay: return .systemFont(ofSize: 15)
      #if compiler(>=5.3)
      case .mac: return .systemFont(ofSize: 19)
      #endif
      // default values
      case .unspecified: fallthrough
